...
" Make tags
map <leader>tg :!ctags --exclude=.git -R ./src<cr><cr>
...
" YouCompleteMe
let g:ycm_global_ycm_extra_conf = '~/.vim/github-Valloric-YouCompleteMe/conf/ycm_c++_conf.py'
